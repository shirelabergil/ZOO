	...
	public static boolean eat(Object animal, IEdible food) {
		...
		if (animal instanceof Carnivore) {
          		...
          		if(((Carnivore)animal).canEat(food.getFoodtype())){
          			...
          			((Carnivore) animal).makeSound();
          			 MessageUtility.logBooleanFunction(((Carnivore)animal).getName(), "eat", food,((Carnivore)animal).canEat(food.getFoodtype()));
          			 return true;
          		}      
		}
		...
		if (animal instanceof Herbivore) {
				...
				if(((Herbivore)animal).canEat(food.getFoodtype())) {
					...
					MessageUtility.logBooleanFunction(((Herbivore)animal).getName(), "eat", food,((Herbivore)animal).canEat(food.getFoodtype()));
					return true;
				}
		}
		...
		if (animal instanceof Omnivore) {
				...
				if(((Omnivore)animal).canEat(food.getFoodtype())) {
					...
					MessageUtility.logBooleanFunction(((Omnivore)animal).getName(), "eat", food,((Omnivore)animal).canEat(food.getFoodtype()));
					return true;
				}
		}
